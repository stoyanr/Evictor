 ...
 * {@link java.util.concurrent.ConcurrentHashMap} specification. This class is a simple extension of
 * {@link ConcurrentMapWithTimedEvictionDecorator} which always uses an instance of
 * {@link java.util.concurrent.ConcurrentHashMap} as a delegate. For convenience, it provides a
 * number of overloaded constructors which correspond to the constructors provided by the
 * {@link java.util.concurrent.ConcurrentHashMap} class.
 * 
 * <p>
 * Like {@link java.util.concurrent.ConcurrentHashMap}, this class does <em>not</em> allow
