 ...
 * {@link EvictibleEntry} instances in the order they should be evicted. This class does not
 * implement the actual eviction functionality, it should be implemented by its subclasses.
 * 
